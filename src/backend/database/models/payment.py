...
class Payment(Base):
    ...
    payment_method_id = Column(UUID, ForeignKey('payment_methods.payment_method_id'), nullable=False)
    payment_status_id = Column(UUID, ForeignKey('payment_statuses.payment_status_id'), nullable=False)
