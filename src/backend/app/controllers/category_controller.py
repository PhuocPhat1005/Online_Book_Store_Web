...
from app.schemas.category import CategoryCreate, CategoryUpdate, CategoryResponse, CategoryNameQuery
...
@router.get("/categories/name/{category_name}", summary="Get a category by name")
...
@router.put("/categories/{category_id}", summary="Update a category by ID")
...
@router.delete("/categories/{category_id}", summary="Delete a category by ID")
