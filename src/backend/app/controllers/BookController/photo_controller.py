...
async def upload_files(
    ...
    try:
        ...
        if is_ava == 1 and typee == "Book":
            ...
            book_update.book_ava = file_paths[
                0
            ]  # Assuming the first file is used as the avatar
        ...
        return JSONResponse(
            content={"message": "Files uploaded successfully"}, status_code=201
        )
...
async def get_all_in_folder_endpoint(
    typee: str, id_: str, db: AsyncSession = Depends(get_db)
):
    if typee == "Book":
