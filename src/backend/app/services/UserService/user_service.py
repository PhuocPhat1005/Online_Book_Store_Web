...
from app.schemas.AccountSchemas.account import AccountCreate
...
async def send_email_to_user(receiver_email: str, your_subject: str, your_msg: str, link: str):
    msg = MIMEMultipart()
    ...
    <body>
        <p>{your_msg}</p>
        <p>
            <a href="{link}" style="display: inline-block; padding: 10px 20px; color: white; background-color: #007BFF; text-decoration: none; border-radius: 5px;">Follow this link</a>
        </p>
    </body>
    </html>
    """
